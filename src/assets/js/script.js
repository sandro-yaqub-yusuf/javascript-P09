...
level1Button.addEventListener('click', (event) => {
  if (level1Button.checked) {
    levelMemory = 10;

    level2Button.checked = false;
  }
});
...
function check() {
  ...
  if (playerOrder.length === levelMemory && good) winGame();
